...
#drop schema
psql --dbname=postgresql://${POSTGRES_USER}:${POSTGRES_PASSWORD}@${POSTGRES_HOST}:${POSTGRES_PORT}/${POSTGRES_DB} -t -c 'DROP SCHEMA IF EXISTS public CASCADE' > ${BACKUP_RESTORE_LOG} 2>&1
